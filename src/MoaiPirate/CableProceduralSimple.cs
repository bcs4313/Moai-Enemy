...
namespace MoaiEnemy.src.MoaiPirate
{
    ...
    // Author of script: DrinkingWindGames
    // I do not take credit for this procedural cable / chain code. 
    // This would be very annoying to make myself
    [RequireComponent(typeof(LineRenderer))]
    [ExecuteAlways]
    public class ShipCableProceduralSimple : MonoBehaviour
    {
